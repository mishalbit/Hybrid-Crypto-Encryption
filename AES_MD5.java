...
public class AES_MD5{
    ...
    public static void main(String []ar) throws Exception{
        ...
        System.out.println("Length Of AES Encrypted Text in bits  : "+cipherText.length+"bits");

        System.out.println("Hashed text By MD5 : "+encryptedText2);
